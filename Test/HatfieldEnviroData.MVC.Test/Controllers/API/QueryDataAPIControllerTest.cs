...
namespace HatfieldEnviroData.MVC.Test.Controllers.API
{
    ...
    public class QueryDataAPIControllerTest
    {
        ...
        public void GetTest()
        {
            ...
            var mockSiteRepository = new Mock<IRepository<Site>>();
            var mockVarRepository = new Mock<IVariableRepository>();
            ...
            var controller = new QueryDataAPIController(mockRepository.Object, mockVarRepository.Object, mockSiteRepository.Object);
